package com.guhecloud.rudez.npmarket.service;
...
/**
 * Created by homework on 2019/4/8.
 */
...
public class MyMqttService extends Service {
    ...
    public        String HOST           = "tcp://39.97.164.154:61613";//服务器地址（协议+地址+端口号）
...
//            Intent intent=new Intent(MyMqttService.this,MessageActivity.class);
//            startActivity(intent);
            showNotifycation(new String(message.getPayload()));
    ...
    public int NOTIF_CONNECTED=5000;
    public void showNotifycation(String text){
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this);
        builder.setContentTitle("农批市场");
        builder.setContentText(text);
        builder.setAutoCancel(true);
        builder.setSmallIcon(R.mipmap.icon_home);
        ...
        manager.notify(NOTIF_CONNECTED++, n);
    }
